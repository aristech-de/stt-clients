...
export enum LanguageSelectionMode {
...
export function languageSelectionModeFromJSON(object: any): LanguageSelectionMode {
  switch (object) {
    case 0:
    case "FIXED":
...
export function languageSelectionModeToJSON(object: LanguageSelectionMode): string {
  switch (object) {
...
export interface StreamingRecognitionResponse {
   ...
   */
  metrics: { [key: string]: StreamingRecognitionResponse_PerformanceMetric };
}

/** Performance metrics for the current chunk. */
export interface StreamingRecognitionResponse_PerformanceMetric {
...
export interface StreamingRecognitionResponse_MetricsEntry {
  key: string;
  value: StreamingRecognitionResponse_PerformanceMetric | undefined;
}
...
export const StreamingRecognitionResponse: MessageFns<StreamingRecognitionResponse> = {
  encode(message: StreamingRecognitionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.metrics).forEach(([key, value]) => {
      StreamingRecognitionResponse_MetricsEntry.encode({ key: key as any, value }, writer.uint32(42).fork()).join();
    });
    return writer;
  },
  ...
  fromJSON(object: any): StreamingRecognitionResponse {
    return {
      ...
      metrics: isObject(object.metrics)
        ? Object.entries(object.metrics).reduce<{ [key: string]: StreamingRecognitionResponse_PerformanceMetric }>(
          (acc, [key, value]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<StreamingRecognitionResponse>, I>>(object: I): StreamingRecognitionResponse {
    ...
    message.metrics = Object.entries(object.metrics ?? {}).reduce<
      { [key: string]: StreamingRecognitionResponse_PerformanceMetric }
    >((acc, [key, value]) => {
      if (value !== undefined) {
...
function createBaseStreamingRecognitionResponse_PerformanceMetric(): StreamingRecognitionResponse_PerformanceMetric {
  return { number: undefined, duration: undefined };
}

export const StreamingRecognitionResponse_PerformanceMetric: MessageFns<
  StreamingRecognitionResponse_PerformanceMetric
> = {
  encode(
    message: StreamingRecognitionResponse_PerformanceMetric,
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StreamingRecognitionResponse_PerformanceMetric {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): StreamingRecognitionResponse_PerformanceMetric {
    return {
  ...
  toJSON(message: StreamingRecognitionResponse_PerformanceMetric): unknown {
    const obj: any = {};
    if (message.number !== undefined) {
  ...
  create<I extends Exact<DeepPartial<StreamingRecognitionResponse_PerformanceMetric>, I>>(
    base?: I,
  ): StreamingRecognitionResponse_PerformanceMetric {
    return StreamingRecognitionResponse_PerformanceMetric.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<StreamingRecognitionResponse_PerformanceMetric>, I>>(
    object: I,
  ): StreamingRecognitionResponse_PerformanceMetric {
    const message = createBaseStreamingRecognitionResponse_PerformanceMetric();
...
function createBaseStreamingRecognitionResponse_MetricsEntry(): StreamingRecognitionResponse_MetricsEntry {
  return { key: "", value: undefined };
}

export const StreamingRecognitionResponse_MetricsEntry: MessageFns<StreamingRecognitionResponse_MetricsEntry> = {
  encode(message: StreamingRecognitionResponse_MetricsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StreamingRecognitionResponse_MetricsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): StreamingRecognitionResponse_MetricsEntry {
    return {
  ...
  toJSON(message: StreamingRecognitionResponse_MetricsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create<I extends Exact<DeepPartial<StreamingRecognitionResponse_MetricsEntry>, I>>(
    base?: I,
  ): StreamingRecognitionResponse_MetricsEntry {
    return StreamingRecognitionResponse_MetricsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<StreamingRecognitionResponse_MetricsEntry>, I>>(
    object: I,
  ): StreamingRecognitionResponse_MetricsEntry {
    const message = createBaseStreamingRecognitionResponse_MetricsEntry();
...
function createBasePhoneInfo(): PhoneInfo {
  return { startTime: undefined, endTime: undefined, phone: "", confidence: 0 };
}
...
export const Model: MessageFns<Model> = {
  encode(message: Model, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    writer.join();
    if (message.languageSelectionMode !== 0) {
      writer.uint32(104).int32(message.languageSelectionMode);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13: {
          ...
          message.languageSelectionMode = reader.int32() as any;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Model {
    return {
      ...
      endpointing: globalThis.Array.isArray(object?.endpointing)
        ...
        : [],
      languageSelectionMode: isSet(object.languageSelectionMode)
        ? languageSelectionModeFromJSON(object.languageSelectionMode)
        : 0,
    };
  },
  ...
  toJSON(message: Model): unknown {
    ...
    if (message.languageSelectionMode !== 0) {
      obj.languageSelectionMode = languageSelectionModeToJSON(message.languageSelectionMode);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Model>, I>>(object: I): Model {
    ...
    message.languageSelectionMode = object.languageSelectionMode ?? 0;
    return message;
  },
};
...
export const SttServiceService = {
  ...
  streamingRecognize: {
    ...
    requestStream: true,
    responseStream: true,
    requestSerialize: (value: StreamingRecognitionRequest): Buffer =>
      Buffer.from(StreamingRecognitionRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): StreamingRecognitionRequest => StreamingRecognitionRequest.decode(value),
    responseSerialize: (value: StreamingRecognitionResponse): Buffer =>
      Buffer.from(StreamingRecognitionResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): StreamingRecognitionResponse => StreamingRecognitionResponse.decode(value),
  },
  ...
  models: {
    ...
    requestSerialize: (value: ModelsRequest): Buffer => Buffer.from(ModelsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ModelsRequest => ModelsRequest.decode(value),
    responseSerialize: (value: ModelsResponse): Buffer => Buffer.from(ModelsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): ModelsResponse => ModelsResponse.decode(value),
  },
  ...
  nlpFunctions: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: NLPFunctionsRequest): Buffer => Buffer.from(NLPFunctionsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): NLPFunctionsRequest => NLPFunctionsRequest.decode(value),
    responseSerialize: (value: NLPFunctionsResponse): Buffer =>
      Buffer.from(NLPFunctionsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): NLPFunctionsResponse => NLPFunctionsResponse.decode(value),
  },
  accountInfo: {
    path: "/ari.stt.v1.SttService/AccountInfo",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: AccountInfoRequest): Buffer => Buffer.from(AccountInfoRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): AccountInfoRequest => AccountInfoRequest.decode(value),
    responseSerialize: (value: AccountInfoResponse): Buffer => Buffer.from(AccountInfoResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): AccountInfoResponse => AccountInfoResponse.decode(value),
  },
  ...
  nlpProcess: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: NLPProcessRequest): Buffer => Buffer.from(NLPProcessRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): NLPProcessRequest => NLPProcessRequest.decode(value),
    responseSerialize: (value: NLPProcessResponse): Buffer => Buffer.from(NLPProcessResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): NLPProcessResponse => NLPProcessResponse.decode(value),
  },
} as const;
